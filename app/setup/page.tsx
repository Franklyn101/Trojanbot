    ...
    <div className="min-h-screen bg-slate-900 p-6">
      <div className="max-w-4xl mx-auto">
          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                ...
                <p className="text-white font-mono">@TrojanHunterBot</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm">Bot Token</p>
                <p className="text-white font-mono">8060712008:AAH8Mp308HHmAdAcr6mp4IM1Pv0HFQRQpCc</p>
              </div>
        ...
        <div className="mt-8 text-center">
          ...
          <Button
            onClick={() => window.open("https://t.me/TrojanHunterBot", "_blank")}
            className="bg-blue-600 hover:bg-blue-700"
          >
            Open @TrojanHunterBot
          </Button>
        </div>
      </div>
    </div>
